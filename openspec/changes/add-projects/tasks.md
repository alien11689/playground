...
- [ ] 3.1 Implement createProject() with validation (name required, status defaults to ACTIVE)
...
- [ ] 3.5 Implement archiveProject() with action=archive query param and rejectUnfinishedTasks parameter
- [ ] 3.6 Implement restoreProject() with action=restore query param
